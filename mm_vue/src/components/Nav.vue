<template>
    <nav class="navbar is-info" role="navigation" aria-label="main naviation" style="min-height: 3.5rem;">
        <div class="navbar-brand">
            <router-link class="navbar-item is-size-4" to="/">MicroMastery</router-link>
        </div>
